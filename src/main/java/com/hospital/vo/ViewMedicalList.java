...
public class ViewMedicalList {

	private ArrayList<ViewMedicalVO> viewMedicalVOList = new ArrayList<>();
...
//	totalCount == diffDay 이다 , totalCount와 startNo, endNo는 인덱스번호이다
	...
	public ViewMedicalList() {
		// TODO Auto-generated constructor stub
	}

	public ViewMedicalList(int pageSize, int totalCount, int currentPage) {
		super();
	...
	public ArrayList<ViewMedicalVO> getViewMedicalVOList() {
		return viewMedicalVOList;
	}

	public void setViewMedicalVOList(ArrayList<ViewMedicalVO> viewMedicalVOList) {
		this.viewMedicalVOList = viewMedicalVOList;
	}
	...
	public String toString() {
		return "ViewMedicalList [viewMedicalVOList=" + viewMedicalVOList + ", pageSize=" + pageSize + ", totalCount="
